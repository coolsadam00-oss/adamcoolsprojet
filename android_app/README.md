...
```gradle
buildConfigField "String", "BASE_URL", "\"https://gexora.onrender.com/\""
```
...
- Privacy policy URL: `https://gexora.onrender.com/privacy`
- Terms/rules URL: `https://gexora.onrender.com/terms`
- Target SDK: 35
